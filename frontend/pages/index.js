...
export default function Home() {
  ...
  const sampleQuestions = [
    "What is the total investment amount made by Microsoft to embed 6000 specialists into client environments for deploying AI models?",
    "According to the FDE brochure, what is the core issue with Gen-AI pilots in production environments that has contributed to a 729% increase in FDE hiring posts?",
